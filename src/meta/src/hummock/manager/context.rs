...
use risingwave_pb::hummock::{HummockPinnedVersion, HummockSnapshot, ValidationTask};
...
impl HummockManager {
    ...
    #[cfg(any(test, feature = "test"))]
    pub async fn pin_snapshot(&self, _context_id: HummockContextId) -> Result<HummockSnapshot> {
    ...
    #[cfg(any(test, feature = "test"))]
    pub async fn unpin_snapshot(&self, _context_id: HummockContextId) -> Result<()> {
        // TODO #18214: remove this method
        Ok(())
    }
    ...
    pub async fn unpin_snapshot_before(
        ...
        _hummock_snapshot: HummockSnapshot,
    ) -> Result<()> {
        // TODO #18214: remove this method
        Ok(())
    }
